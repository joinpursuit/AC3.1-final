...
Run the tests by runnning `npm test` (you can also just run `mocha` from the command line). This should automatically run your tests for you whenever you answers file changes.
