...
function highLow(arr){
  output = {}
  var maxz = arr.sort(function(a,b){
    return (a < b)
  })
  output.high = maxz[0];
  output.low = maxz[maxz.length-1];
  return output
...
function indexMap(arr){
  var newArr = arr.map(function(val, indx){
    return val * indx
  })
  return newArr
}
...
function changeBearPig(){
   var dog = document.getElementById('text1');
