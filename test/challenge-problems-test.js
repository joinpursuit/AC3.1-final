...
const {sumArray, sumAll, squaredTimesTen, highLow, halfsies, indexMap, oddNumStrs, leet, oddsAndEvens, palindrome, anagram, Song, Album} = require('../answers/answers');

describe('final challenge problems test', () => {
  it('sumArray()', () => {
